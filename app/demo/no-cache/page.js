...
export default async function NoCachePage() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-4 text-gray-900">Пост без кешування</h1>
      <div className="bg-gray-50 border border-gray-200 p-4 rounded mb-4 text-sm text-gray-700">
        <p>Цей пост не кешується: дані завантажуються заново при кожному запиті.</p>
        <p className="mt-1">Поведінка однакова і в режимі розробки, і у production.</p>
      </div>
